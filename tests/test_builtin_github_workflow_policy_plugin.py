...
from nexus.plugins.builtin.github_workflow_policy_plugin import GithubWorkflowPolicyPlugin
...
def test_github_workflow_policy_list_and_comments_and_pr():
    ...
    plugin = GithubWorkflowPolicyPlugin(
        {
...
def test_github_workflow_policy_resolve_repo_for_issue():
    ...
    plugin = GithubWorkflowPolicyPlugin({"get_issue": _get_issue})
