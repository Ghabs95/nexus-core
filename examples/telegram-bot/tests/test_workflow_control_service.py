...
def test_prepare_continue_context_prefers_recovered_next_agent_over_stale_running_step(
    ...
    ctx = svc.prepare_continue_context(
        ...
        resolve_project_config_from_task=lambda _p: ("nexus", {"agents_dir": "agents", "workspace": "."}),
        get_runtime_ops_plugin=lambda **_k: SimpleNamespace(find_agent_pid_for_issue=lambda _n: None),
