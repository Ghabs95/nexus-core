...
if _SA_AVAILABLE:
	...
	class _InboxTaskRow(_InboxBase):
		...
		claimed_at: sa.orm.Mapped[datetime | None] = sa.orm.mapped_column(sa.DateTime(timezone=True))
		processed_at: sa.orm.Mapped[datetime | None] = sa.orm.mapped_column(sa.DateTime(timezone=True))
